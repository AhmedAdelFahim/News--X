...
const NewsCard = (props) => {
    ...
    return (<div className="news-card-container">
        ...
        <div className="news-card-body">
            <div className="module title-clamp news-title"
                 dangerouslySetInnerHTML={{__html: DOMPurify.sanitize(`<a href=${url}><p>${title}</p></a>`)}}>
            ...
            <div className="details-container">
                <div><FontAwesomeIcon icon={faClock} color="#ffffff"/> <p className="published-at">{publishedAt}</p>
                </div>
