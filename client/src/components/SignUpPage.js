    ...
    return(<div className="container-center page-container">
        <div className="form-container">
            ...
            <div className="inputs-container">
                <div>
                    <input className="custom-input" type="text" placeholder="Full Name" value={name} onChange={handleChangeName}/>
                ...
                <div>
                    <input className="custom-input" type="password" placeholder="Password Confirmation" value={passwordConfirmation} onChange={handleChangePasswordConfirmation}/>
                    {props.errors && props.errors.passwordConfirmation && <ErrorMessage message={props.errors.passwordConfirmation}/>}
                </div>
                <div>
                    <button className="submit-btn" onClick={handleSubmit} disabled={props.isLoadingSignup}>SIGN UP</button>
                </div>
            </div>
        </div>
